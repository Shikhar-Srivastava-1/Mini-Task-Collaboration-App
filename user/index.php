...
<body class="bg-gray-50 font-sans text-gray-900">
    ...
    <header class="bg-white shadow-sm h-14 w-full fixed top-0 z-50 flex items-center justify-between px-4">
        <div class="flex items-center space-x-3">
            ...
            <div class="text-xl font-semibold text-teal-500">User Portal</div>
        </div>
    </header>
                ...
                data.tasks.forEach(task => {
                    ...
                    row.innerHTML = `
                        ...
                        <td class="px-3 py-2 text-xs font-medium">
                            ${task.user_id == userId ? `
                                <a href="#" class="text-indigo-600 hover:text-indigo-800 edit-task" data-id="${task.id}">
                                ...
                                <a href="#" class="text-teal-600 hover:text-teal-800 ml-2 toggle-description" data-id="${task.id}">
                                    <svg class="h-4 w-4 inline" fill="none" stroke="currentColor" viewBox="0 0 24 24">
